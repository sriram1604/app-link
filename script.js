document.addEventListener('DOMContentLoaded', () => {
    ...
    let chatbotData = {
        "en": {
            ...
            "questions": [
                { "pattern": "who|what|about|company|pks|pak|explain|precision|allied|krafts", "response": "PKS Enterprises (Precision Allied Krafts) provides contract-based skilled and unskilled manpower for cardboard manufacturing, packaging units, and industrial operations." },
        ...
        "ta": {
            ...
            "questions": [
                { "pattern": "யார்|தகவல்|பற்றி|pks|pak|விளக்கம்|இணையதளம்", "response": "PKS Enterprises அட்டை பெட்டி தயாரிப்பு மற்றும் பேக்கேஜிங் தொழில்களுக்குத் தேவையான தொழிலாளர்களை ஒப்பந்த அடிப்படையில் (https://pakenterprises.in/) வழங்குகிறது." },
        ...
        "hi": {
            ...
            "questions": [
                { "pattern": "कौन|बारे में|कंपनी|pks|pak|विवरण|वेबसाइट", "response": "PKS Enterprises औद्योगिक इकाइयों के लिए अनुबंध-आधारित जनशक्ति, उपस्थिति प्रणाली और डिजिटल समाधान (https://pakenterprises.in/) प्रदान करता है।" },
