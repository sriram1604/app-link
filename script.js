document.addEventListener('DOMContentLoaded', () => {
    ...
    let chatbotData = {
        "en": {
            "welcome": "Hello! I am your PKS Assistant. Ask your doubts about Pak Enterprises.",
            ...
            "questions": [
                { "pattern": "who|what|about|company|pks|pak|explain|precision|allied|krafts", "response": "Pak Enterprises (Precision Allied Krafts) provides contract-based skilled and unskilled manpower for cardboard manufacturing, packaging units, and industrial operations." },
        ...
        "ta": {
            "welcome": "வணக்கம்! நான் உங்கள் PKS உதவியாளர். Pak Enterprises பற்றிய உங்கள் சந்தேகங்களைக் கேளுங்கள்.",
            ...
            "questions": [
                { "pattern": "யார்|தகவல்|பற்றி|pks|pak|விளக்கம்|இணையதளம்", "response": "Pak Enterprises அட்டை பெட்டி தயாரிப்பு மற்றும் பேக்கேஜிங் தொழில்களுக்குத் தேவையான தொழிலாளர்களை ஒப்பந்த அடிப்படையில் (https://pakenterprises.in/) வழங்குகிறது." },
        ...
        "hi": {
            "welcome": "नमस्ते! मैं आपका PKS सहायक हूँ। Pak Enterprises के बारे में अपनी शंकाएं पूछें।",
            ...
            "questions": [
                { "pattern": "कौन|बारे में|कंपनी|pks|pak|विवरण|वेबसाइट", "response": "Pak Enterprises औद्योगिक इकाइयों के लिए अनुबंध-आधारित जनशक्ति, उपस्थिति प्रणाली और डिजिटल समाधान (https://pakenterprises.in/) प्रदान करता है।" },
